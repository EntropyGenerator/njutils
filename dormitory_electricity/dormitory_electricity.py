...
if __name__ == '__main__':
    ...
    if username==None or password==None:
        print("Username or password not set. Please configure them in the .env file")
        exit(1)
    ...
    try:
        ...
        print(f"campus_id: {campus_id}, area_id: {area_id}, building_id: {building_id}, room_id: {room_id}")
    except Exception as e:
...
def get_elec_degree():
    ...
    if (username and password and campus_id and area_id and building_id and room_id)==None:
        print("Infomation not set. Please configure them in the .env file")
        return None
